...
<asp:Content ID="Content1" ContentPlaceHolderID="Contenido" runat="server">
    <center><asp:Panel ID="Panel1" runat="server">
        <asp:GridView ID="gridProfesores" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" DataKeyNames="ID" OnRowDataBound="gridProfesores_RowDataBound" OnSelectedIndexChanged="gridProfesores_SelectedIndexChanged" EmptyDataText="No hay profesores disponibles">
