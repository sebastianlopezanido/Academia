...
<body style="height: 570px">
    <form id="form1" runat="server">
        <center><asp:Panel ID="Panel1" runat="server" Height="474px"><br /><br /><br /><br /><br /><br /><br /><br />
            <asp:Login ID="Login1" runat="server" Height="150px" Width="236px" BorderColor="Black">
                <LayoutTemplate>
                                ...
                                <table cellpadding="0" style="height:150px;width:236px;">
                                    ...
                                    <tr>
                                        <td align="right" colspan="2">
                                            <asp:Button ID="LoginButton" runat="server" CommandName="Login" OnClick="LoginButton_Click" Text="Ingresar" ValidationGroup="Login1" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
